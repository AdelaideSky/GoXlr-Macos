...
struct MicView: View {
    ...
    //-----------------------------------------------[ Mic status block ]--------------------------------------------------------//
                    ...
                    MicStatusView(mixer: mixer)
    //-----------------------------------------------[ DEESSER Expanded ]-------------------------------------------------------//

                    DeEsserView(mixer: mixer)
    //-------------------------------------------------[ COMP Simplified ]--------------------------------------------------------//
    ...
    //--------------------------------------------------[ NG Expanded ]----------------------------------------------------------//
                            ...
                            if gateExpanded {
                                HStack {
                                    ...
                                    .padding(.top, 10)
                                NoiseGateView(mixer: mixer, expanded: true)
                            }
    //--------------------------------------------------[ NG Simplified ]---------------------------------------------------------//
                                ...
                                HStack {
                                    ...
                                    .padding(.top, 10)
                                NoiseGateView(mixer: mixer, expanded: false)
                            }
                        }
    ...
    //--------------------------------------------------[ EQ Expanded ]----------------------------------------------------------//
                            ...
                            if eqExpanded {
                                ...
                                EqualiserView(mixer: mixer, expanded: true, fineTune: fineTune)
    //--------------------------------------------------[ EQ Simplified ]---------------------------------------------------------//
                                ...
                                HStack {
                                    ...
                                    .padding(.top, 10)
                                EqualiserView(mixer: mixer, expanded: false, fineTune: false)
                            }
                        }
...
//-------------------------------------------------[ COMP Expanded ]--------------------------------------------------------//
                ...
                if compExpanded {
                    VStack {
                        ...
                        CompressorView(mixer: mixer, expanded: true)
                    }.padding(1)
                        .padding(.top, 5)
...
//-------------------------------------------------[ COMP Simplified ]--------------------------------------------------------//
                    ...
                    VStack {
                        ...
                        CompressorView(mixer: mixer, expanded: false)
